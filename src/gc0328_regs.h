#pragma once
/* GC0328 register tables — extracted verbatim from
   PureHing/k210-camera-project (Apache-2.0), the working K210 GC0328 driver.
   0xff in the reg column means: delay (value) ms. */
#include <stdint.h>
