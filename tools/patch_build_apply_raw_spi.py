...
# Fast/stable ESP8285 flashing baseline.  ESP8266 ROM sync stays at 115200,
# then the uploaded stub is switched to 921600.  4096-byte packets timeout on
# the current K210<->ESP path, so keep the UART fast but use stable 1024 blocks.
...
s = s.replace("#define ESP_ROM_BAUD         115200u\n#define ESP_FLASH_BAUD       921600u\n#define ESP_FLASH_BLOCK      4096u",
              "#define ESP_ROM_BAUD         115200u\n#define ESP_FLASH_BAUD       921600u\n#define ESP_FLASH_BLOCK      1024u")
...
print("ESP_FLASH_FAST_PATCH_OK rom_baud=115200 flash_baud=921600 block=1024")
